...
describe("openwith", () => {
  ...
  describe(".getVerbosity()", () => {
    it("is a function", () =>
      expect(openwith.getVerbosity).to.be.a("function"));
    it("returns the verbosity level", () =>
      expect(openwith.getVerbosity()).to.be.a("number"));
  });

  describe(".exit()", () => {
    it("is a function", () => expect(openwith.exit).to.be.a("function"));
  });

  describe(".setVerbosity()", () => {
    it("is a function", () =>
      expect(openwith.setVerbosity).to.be.a("function"));
    it("accepts only valid verbosity levels", () => {
      expect(openwith.setVerbosity)
        .withArgs(openwith.DEBUG)
        .to.not.throwError();
